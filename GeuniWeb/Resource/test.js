...
//////////////////////////////////////////////////////////////////////////
function removeSplashImageUrl() {
    var params = {
        "splashImageUrl" : ""
    };
    sendNativeAction("AppConfiguration", "set", params)
}

function applySplashImageUrl() {
    var params = {
        "splashImageUrl" : "https://static.remove.bg/sample-gallery/graphics/bird-thumbnail.jpg"
    };
    sendNativeAction("AppConfiguration", "set", params)
}

function applySplashImageUrlBoro() {
    var params = {
        "splashImageUrl" : "https://static.ebs.co.kr/images/public/lectures/2014/06/19/10/bhpImg/44deb98d-1c50-4073-9bd7-2c2c28d65f9e.jpg"
    };
    sendNativeAction("AppConfiguration", "set", params)
}
...
function goAdminPage() {
    var params = { };
    sendNativeAction("Navigator", "goAdmin", params)
}

function currentLocation() {
    var params = { };
    sendNativeAction("Location", "current", params)
}

function isOnBackGesture() {
    var params = {
        "value" : true
    };
...
function openCamera() {
    var params = { };
    sendNativeAction("Camera", "open", params)
}
